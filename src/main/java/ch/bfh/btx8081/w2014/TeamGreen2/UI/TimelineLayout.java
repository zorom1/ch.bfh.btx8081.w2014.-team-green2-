...
/**
 * The Following Class provides a View of the external medical events of the
 * Patient. The data is written in an Excel-File which is placed on an external
 * timeline-server (here simulated with the website medicaltimeline.jimdo.com.
 * The doctor can download that external Excel-File and see all the medical
 * events of the Patient that have occured.
 * 
 * @author JD
 *
 */
...
public class TimelineLayout extends BorderPanel {
	...
	/**
	 * This method implements the layout and the link of the timeline, with a
	 * preview of the timeline (here simulated with a screenshot.)
	 */
	...
	public TimelineLayout() {
		...
		String basepath = VaadinService.getCurrent().getBaseDirectory()
				.getAbsolutePath();
		this.timelinepreview.setIcon(new FileResource(new File(basepath
				+ "/META-INF/ExampleTimeLine.png")));
		this.linkTimeline = new Link(
				"Download & View Timeline",
				new ExternalResource(
						"http://medicaltimeline.jimdo.com/app/download/10998507525/Example%20Timeline%20Jane%20Smith.xlsx?t=1420731065"));
	...
	/**
	 * Creates the "Home" Button to exit the application and return to the
	 * HomeView.
	 * 
	 * @return Button
	 */
